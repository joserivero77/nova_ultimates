    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-4 pt-3 pt-md-0">
            ...
            <div class="d-sm flex justify-content-between my-4 pb-4 border-bottom">
                ...
                <button wire:click="savePurchase()" class="btn btn-primary btn-block"><i class="fas fa-shopping-cart"></i>Confirmar compra</button>

                <button wire:click="cancelPurchase()" class="btn btn-secondary btn-block"><i class="fa fa-bug"></i> Cancelar</button>
