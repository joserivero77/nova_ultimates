            ...
            <div class="col-lg-3 col-sm-3 col-md-3 col-xl-3 col-xxl-3 col-3">
                ...
                <div class="dropdown open">
                    <a href="#" class=" btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                        type="button" id="triggerId" aria-expanded="false"><i class="fa fa-shopping-cart"></i>
                    ...
                    <div class="dropdown-menu" aria-labelledby="triggerId">
                        <div class="row total-header-section">
                            ...
                            <div class="col-lg-12 col-sm-12 col-12 total-section text-right">
                                <p>
                                <h4>Total:<span class="text-info">Bs {{ $total }}</h3></span></p>
                            </div>
                                        ...
                                        <div class="row cart-detail">
                                            <div class="col-lg-5 col-sm-5 col-5 cart-detail-img p-md-2">
                                                <img style="max-width: 80px"
                                                    src="{{ asset('/image') }}/{{ $details['image'] }}" alt="">
                                            </div>
        ...
        <div class="row">
            <div class="col-xl-5 col-md-4 pt-3 pt-md-0">
                <h2 class="h6 d-flex flex-wrap justify-content-between align-items-center px-4 py-3 bg-warning">
                    <span><b>CATALOGO DE PRODUCTOS</b></span>
                </h2>
    ...
    <table class="table table-primary">
        <thead>
            <tr>
                ...
                <th scope="col">subtotal 3</th>
            </tr>
        </thead>
        <tbody>
            <tr class="">
                <td><label for="" id="label0">8</label></td>
                                                    <td><input type="number" id="text"></td>
            ...
            <div class="col-xl-7 col-md-8"><!--DESDE AQUI VISTA DE LA TABLA-->
                <h2 class="h6 d-flex flex-wrap justify-content-between align-items-center px-4 py-3 bg-warning">
                    <span class="mt-1 text-bg-black"><b>PRODUCTO</b></span>
                </h2>
                <div class="d-sm flex justify-content-between my-4 pb-4 border-bottom">
                    <div class="media d-block d-sm-flex text-center">
                        <div class="media-body pt-0">
                            <div class="form-group">
                                <input type="text" class="form-control" value="" placeholder="Buscar producto"
                                    aria-label="Search">
                            ...
                            <h2 class="h6 d-flex flex-wrap justify-content-between align-items-center px-4 py-3 bg-warning">
                                <span class="mt-1 text-bg-black"><b>Compras o Carrito</b></span>
                            </h2>
                            <div class="table-responsive">
                                <table class="table">
                                    <thead>
                                        ...
                                        @if (session('cart'))
                                            @foreach (session('cart') as $id => $details)
                                                ...
                                                <tr data-id="{{ $id }}">
                                                    ...
                                                    <td data-th="Subtotal">
                                                        {{ $details['precio_venta'] * $details['quantity'] }}</td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="5" class="text-right">
                                                <h3><strong>Total Bs{{ $total }}</strong></h3>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="5" class="text-right">
                        ...
                        <div class="d-sm flex justify-content-between my-3 pb-3 border-bottom">
                            <div class="media d-block d-sm-flex text-center">
                                <div class="media-body pt-3">
                                    <h6 class="product-card-title fonr-weight-semibold border-0 pb-0"><a
                                            href=""><b>CANTIDAD DE PRODUCTOS</b></a></h6>
                                ...
                                <div class="row">
                                    <div class="col-xl-7 col-md-4 pt-3 pt-md-0">
                                        <div class="form-group">
                                            ...
                                            <select wire:model.lazy="provider" class="form-control" name=""
                                                id="">
                            ...
                            <button class="btn btn-primary btn-block"><i class="fas fa-shopping-cart"></i>Confirmar
                                compra</button>
