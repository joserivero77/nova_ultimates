                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <label for="" class="form-label text-white badge-dark " id="monto">
                                            <h3><b> {{ number_format($total, 2) }}</b>
                                                <label for="" id="totalLabel">/Ref_<p id="total$"></p>
                                                </label>
                                            </h3>
                                        </label>
                                    </div>
                                    ...
                                    <div class="mb-1">
                                        <label for="" class="form-label" id="tasa1">Tasa de cambio</label>
                                    ...
                                    <div class="mb-1">
                                        <label for="" class="form-label" id="parcialLabel">Pago Realizado Bs</label>
                                    ...
                                    <div class="mb-1">
                                        <label for="" class="form-label text-bg-primary" id="pagoLabel">Pago total Bs</label>
